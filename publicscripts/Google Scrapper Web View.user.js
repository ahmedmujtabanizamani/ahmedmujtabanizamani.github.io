...
(function() {
    ...
    progressEle.style.cssText = "display: none; position: absolute; width: 80%; height: 80%; left: calc(10% - 50px); top: calc(10% - 50px); opacity: 0.7; border-radius: 50px; color: lightgreen; background-color: black; padding: 50px; z-index: 10000";
})();